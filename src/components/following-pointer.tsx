...
export const FollowPointer = ({ x, y, title }) => {
  ...
  return (
    <motion.div
      ...
      style={{ top: y, left: x, pointerEvents: "none", zIndex: 9999 }} // Setting z-index to a high value
    ...
    >
      ...
      <motion.div
        ...
        className="px-2 py-2 bg-neutral-200 text-white whitespace-nowrap min-w-max text-xs rounded-full absolute top-6 left-6"
      >
