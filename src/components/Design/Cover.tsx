...
import { cn } from "../lib/utils"; // Ensure the cn utility is available or replace it
import { SparklesCore } from "./sparkles"; // Ensure SparklesCore is implemented in your project
